...
public class ObjectFactory {
    ...
    private final static QName _ListResponse_QNAME = new QName("http://webservices/", "listResponse");
    private final static QName _List_QNAME = new QName("http://webservices/", "list");
    private final static QName _Create_QNAME = new QName("http://webservices/", "create");
    private final static QName _CreateResponse_QNAME = new QName("http://webservices/", "createResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "listResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "list")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "create")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "createResponse")
